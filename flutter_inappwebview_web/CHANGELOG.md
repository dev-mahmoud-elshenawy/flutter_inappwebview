...
- Fixed "Flutter 3.7.10 error Dart library 'dart:ui_web' is not available on this platform" [#1900](https://github.com/dev-mahmoud-elshenawy/flutter_inappwebview/issues/1900)
