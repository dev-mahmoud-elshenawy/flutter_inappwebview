...
import com.dev_mahmoud_elshenawy.flutter_inappwebview_android.credential_database.CredentialDatabase;
...
import com.dev_mahmoud_elshenawy.flutter_inappwebview_android.types.URLCredential;
import com.dev_mahmoud_elshenawy.flutter_inappwebview_android.types.URLProtectionSpace;
...
public class InAppWebViewClient extends WebViewClient {
  ...
  public void onSafeBrowsingHit(final WebView view, final WebResourceRequest request, final int threatType, final SafeBrowsingResponse callback) {
    ...
    final WebViewChannelDelegate.SafeBrowsingHitCallback resultCallback = new WebViewChannelDelegate.SafeBrowsingHitCallback() {
      @Override
      public boolean nonNullSuccess(@NonNull com.dev_mahmoud_elshenawy.flutter_inappwebview_android.types.SafeBrowsingResponse response) {
        Integer action = response.getAction();
        if (action != null) {
      ...
      @Override
      public void defaultBehaviour(@Nullable com.dev_mahmoud_elshenawy.flutter_inappwebview_android.types.SafeBrowsingResponse result) {
